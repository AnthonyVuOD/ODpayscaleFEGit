      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            See what a fair salary is and help others by providing your compensation package.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            With this application, you will be able to not only provide your compensation package as an OD, but you will also be able to provide your previous compensation packages too. 
          </p>
        </div>
      </Container>
