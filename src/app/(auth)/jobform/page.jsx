...
export default function JobForm (){
    ...
    //Switch to show/hide contractor Job form and w-2 job form
    const [showContractorOrW2, setShowContractorOrW2] = useState('')
    ...
    return (
        <Container>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Is this an independet contractor job (1099) or an employed job(W-2)?
                    </p>
                    <br />
                    {/* <Switch
                        checked = {enabled}
                    ...
                    <div className="card flex justify-content-center">
                        {/* {/* <div className="flex flex-wrap gap-3"> */}
                            <div className="flex align-items-center mx-10"> 
                                <RadioButton 
                                    type='radio'
                                    inputId="contractor" 
                                    name="showContractorOrW2" 
                                    value="contractor" 
                                    onChange={(e) => setShowContractorOrW2(e.value)} 
                                    checked={showContractorOrW2 === 'contractor'} />
                                <label 
                                    htmlFor="contractor" 
                                    // className="ml-10"
                                    >Contractor (1099)
            ...
            <form onSubmit={createContractorJob}>
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">1099 Job Salary Details</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">
            ...
            <form onSubmit={createW2Job}>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">W-2 Job Salary Details</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Please answer a few questions about your salary details:
                    </p>
