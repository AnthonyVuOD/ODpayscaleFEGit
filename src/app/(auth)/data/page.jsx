                ...
                <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                  ...
                  <DataTable 
                    ...
                    >
                      ...
                      <Column className="px-3 py-3.5 text-left text-sm text-gray-900" field="state" header="State"  style={{ width: '15%' }}></Column>
                      <Column className="px-3 py-3.5 text-left text-sm text-gray-900" field="normalizedAnnualComp" header="Normalized Annual Comp" sortable style={{ width: '20%' }}></Column>
                      <Column className="px-3 py-3.5 text-left text-sm text-gray-900" field="setting" header="Setting"   style={{ width: '15%' }}></Column>
